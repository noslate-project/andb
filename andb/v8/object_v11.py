...
class WasmNull(HeapObject):
    _typeName = 'v8::internal::WasmNull'
    kMapOffset = 0
    kSize = 8
...
class InstructionStream(HeapObject):
    _typeName = 'v8::internal::InstructionStream'
    ...
    def __autoLayout(cls):
        return {"layout": [
            {"name": "code_offset", "type": int},
            {"name": "data_start", "type": int},
